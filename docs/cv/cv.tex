...
\begin{itemize}
	\item{\cventry{2022--Present}
	         ...
	         {Ames, IA}
	         {}
	         {Additional Responsibilities: Co-advise graduate students, serve on thesis committees.}}
...
\begin{itemize}
	\item{\cventry{2026}
	         ...
	         {Argonne Leadership Computing Facility Director's Discretionary Allocation}
	         {Ames, IA}
	         {}
	         {Renewal: Speeding up the computation of long-range electrostatic interactions in NWChemEx}
	...
	\item{
		...
		{Ames, IA}
		{}
		{Quantum Harmony: Embracing noisy quantum computing}
		{Value of award: \$226,000.00}
		{}
	}
	\item{
		\cventry{2025--2027}
		{Theresa Windus (PI) and \textbf{Ryan M. Richard} (co-PI)}
		{ISU LAS Frontier Science Award}
		{Ames, IA}
		{}
		{Error-Bound Atomistic Simulations for Reliable Machine Learning Models}
		{Value of award: \$100,000.00}
		{}
	}
	\item{
		\cventry{2024--2027}
		...
		{Ames, IA}
		{}
		{REU Site: Sustainability Institute for Machine Learning and 
...
\begin{itemize}
	...
	\item{\cventry{2025}
	         ...
	         {Ames, IA}
	         {}
	         {Speeding up the computation of long-range electrostatic interactions in NWChemEx}
...
\begin{itemize}
	\item{\cventry{2025}
		{Graduate Student Summer Internship. Research focus: uncertainty in eigen solvers}
		{Anna Diaz}
		{Ames, IA}
		{}
		{}}
...
\begin{etaremune}
	...
	\item{\textbf{Ryan M. Richard}. \textit{GhostFragment: a reusable, flexible, 
	         modular library for generalized fragment-based methods}.  
