...
\name{Ryan}{M. Richard}
\title{Chemistry}
\address{Ames National Laboratory and Iowa State University}{Ames, IA}{USA}
...
\small{
	Staff Scientist at Ames National Laboratory and Adjunct Assistant
...
\begin{itemize}
	\item{\cventry{2018--Present}
		  {Architect and lead developer of \textsc{NWChemEx}.}
		  {Scientist II, Ames National Laboratory}
		  {Ames, IA}
		  {}
		  {Additional Responsibilities: Mentor graduate and undergraduate researchers. 
		   Write grants. Present and publish research.}
	}
...
\begin{itemize}
	\item{\cventry{2022--Present}
	         ...
	         {Ames, IA}
	         {}
	         {Additional Responsibilities: Co-advise graduate/undergraduate students, 
	           serve on thesis committees.}}
	\item{\cventry{2017--2018}
		 {Algorithm development, development of massively parallel architecture}
	...
	\item{\cventry{2014--2017}
		  {Algorithm development, high-accuracy benchmarking}
...
\begin{itemize}
	\item{\cventry{2026--present}
	         {Architect and lead developer}
	         {\textsc{QHARM}}
	         {\href{https://github.com/qharm}{GitHub}}
	         {}
	         {\begin{itemize}
	         	\item{\textsc{QHARM} (Quantum Hybrid Algorithm Resource Modules)
	         		provides a user-friendly interface for hybrid classical/quantum computing.}
			\item{Software products:
				\begin{itemize}
					\item \textsc{EigenBridge} --- \url{https://github.com/qharm/EigenBridge}
				\end{itemize}
			}	
	         \end{itemize}}
	}
	\item{\cventry{2017--present}
		...
		{}
		{\begin{itemize}
			\item{Package focused on high-performance, massively parallel electronic structure theory.}
		    	\item{Software products:
		    		\begin{itemize}
					\item \textsc{Chemist} --- \url{https://github.com/NWChemEx/Chemist}
			    		\item \textsc{Integrals} -- \url{https://github.com/NWChemEx/Integrals}
					...
					\item \textsc{NUX} --- \url{https://github.com/NWChemEx/NUX}
					\item \textsc{NWChemEx} --- \url{https://github.com/NWChemEx/NWChemEx}
					\item \textsc{SCF} -- \url{https://github.com/NWChemEx/SCF}
					\item \textsc{SimDE} --- \url{https://github.com/NWChemEx/SimDE}
			    		\item \textsc{TensorWrapper} --- \url{https://github.com/NWChemEx/TensorWrapper}
					\item \textsc{WeaklyTypedFloat} -- \url{https://github.com/NWChemEx/WeaklyTypedFloat}
			    	\end{itemize}
	    		}
		\end{itemize}}
	}
	\item{\cventry{2021--present}
                 ...
                 {\textsc{GhostFragment}}
                 {\href{https://github.com/rmrresearch/GhostFragment}{GitHub}}
                 {}
                 {\begin{itemize}
          		\item{Software for massively parallel generalized many-body
          			 expansion and basis-set superposition corrections.}
                		\item{Contributions: concept, design, CI infrastructure, initial implementations.}
                 \end{itemize}}}
	\item{\cventry{2019--present}
		...
		{\begin{itemize}
			\item{Object-oriented CMake build system.}
	 		\item{Contributions: concept, design, CI infrastructure, CMakePP language}
		   	\item{Software products: 
		   		\begin{itemize}
...
\begin{itemize}
	\item{\textbf{Computational Chemistry Topics:}\\
		  wave function methods, fragment-based methods}
...
\begin{itemize}
	...
	\item{\cventry{2022 -- 2023}
          	...
          	{}
          	{\begin{itemize}
                  \item{Nominees are junior level scientists at the laboratory who show leadership potential.}
                  \item{Program focuses on mentoring and developing leadership skills with a focus on career advancement at a Department of Energy National Laboratory.}
           	 \end{itemize}}}
   	 \item{\cventry{2020 -- 2021}
		 ...
		 {}
		 {\begin{itemize}
   		      \item{Nominees demonstrate potential to lead future high-impact interdisciplinary research teams.}
   		      \item{Provided educational opportunities to refine leadership skills.}
   	 	  \end{itemize}}}
	\item{\cventry{2016}
		  {252$^{nd}$ American Chemical Society National Meeting and Exposition}
	  	 {Finalist for the Emerging Technology in Computational Chemistry Symposium}
	  	 {Philadelphia,PA}
	  	 {}
	  	 {}}
...
\vspace{5pt}
\begin{itemize}
	\item{\cventry{2024--present}
		  {Member of the Sustainable Scientific Software (S3C) organizing team.}  
	      {National Laboratory Information Technology (NLIT) Summit}
		  {}
		  {}
...
\section{Ames National Laboratory Service}
\vspace{5pt}
\begin{itemize}
	\item{\cventry{2026}
	        {Committee Member}
	        {AMES Data Scientist Search Committee}
	        {Ames National Laboratory}
	        {}
	        {Helped prepare interview questions and screen candidates}
	}
	\item{
		\cventry{2024}
		{Panelist.}
...
\section{Iowa State University Service}
\vspace{5pt}
\begin{itemize}
	\item{
		\cventry{2025}
		{Krishna Suresh (substitute)}
...
\section{Georgia Institute of Technology Service}
\vspace{5pt}
\begin{itemize}
	\item{\cventry{2016}
	...
	\item{\cventry{2014--2017}
        ...
        {Atlanta, GA}
        {}
        {Organized monthly social events and an annual university research symposium for postdocs at Georgia Tech.}}
\end{itemize}
...
\section{Students Mentored}
	...
	\begin{itemize}
		\item{\cventry{2025}
			{Research focus: uncertainty in eigen solvers}
			{Anna Diaz}
			{Ames, IA}
			{Summer Internship}{}
		}
		\item {
			...
			{Research focus: Quantum chemistry uncertainty propagation}
			{Shalith Chamantha}
			{Ames, IA}
			{}{}
		}
...
\begin{itemize}
	\item{\cventry{2026}
	         {Research focus: geometry optimization of small peptides}
	         {Ella Bushman}
	         {Ames, IA}
	         {}{}
	}
	\item{\cventry{2026}
	         {Research focus: detecting the primary structure of peptides}
	         {Aspen Meissner}
	         {Ames, IA}
	         {}{}
	}
	\item{\cventry{2025}
		{Research focus: predicting fragments of peptides.}
		{Daniel Woodard}
		{Ames, IA}
		{}{}
	}
...
\section{Other Mentoring Activities}
\vspace{5pt}
\begin{itemize}
	\item{\cventry{2025}
		{Visiting Faculty Program. Research focus: uncertainty in electron repulsion integrals.}
		{Nancy L. Glenn Griesinger}
		{Ames, IA}
		{}
		{}}
\end{itemize}
...
\begin{etaremune}
	\item[]{}
   	\subsection{2025}
	\item {\textbf{Ryan M. Richard}. \textit{TensorWrapper Wishful Thinking?}. Toulouse Tensor Workshop. Toulouse, France.  August 2025}
	\item{\textbf{Ryan M. Richard}. \textit{NWChemEx: Towards a fully reusable electronic structure package}. Majvik, Finland. July 2025} 
	\subsection{2024}
...
\begin{etaremune}
	\item[]{}
	\subsection{2026}
	\item{\textbf{Ryan M. Richard}. 
	         \textit{Designing type-agnostic reusable libraries}. 
	         Oral Presentation.
	         Reusable Libraries in Quantum Chemistry (ReLibQC) 2026 Workshop.
	         Toulouse, France. September 2026.
	}
	\item{Shalith Chamantha Jayasekara Hetti Arachchige and  \textbf{Ryan M. Richard}. 
	         \textit{Quantum Chemistry Uncertainty Propagation (QCUP): Enabling Reliable Low-Tolerance Electronic Structure Calculations}. 
                  Poster Presentation.
	         56th Midwest Theoretical Chemistry Conference. 
	         Minneapolis, MN. May 2026.}
	\subsection{2025}
	\item{\textbf{Ryan M. Richard}. \textit{GhostFragment: a reusable, flexible, 
	         modular library for generalized fragment-based methods}.  Oral Presentation.
	         Pacifichem 2025. Honolulu, HI. December 2025.}
	\subsection{2019}
	\item{\textbf{Ryan M. Richard} and Theresa L. Windus. \textit{CMake 
	      Packaging Project: Reliable, Reproducible, and Reusable Build Systems
		  Made Easy}. Oral Presentation. 257$^{th}$ National American Chemical Society Meeting. 
...
\section{Miscellaneous Workshops and Presentations}
\begin{etaremune}
	\item{Organizer for Virtual Workshop on Multi-Project CI/CD. Virtual. 2024.}
...
\begin{etaremune}
	\item{\textbf{Ryan M. Richard}. \emph{Best Practices for Multi-Project Continuous Integration 
	   	 and Deployment}.\url{https://bssw.io/blog_posts/best-practices-for-multi-project-continuous-integration-and-deployment}.}
...
\item[]{}
	\subsection{2025}
	\item{K.~Fujioka, \textbf{Ryan M. Richard}, J. ~Waldrop, Y.~Lou, T.~L.~Windus, and R. Sun. \textit{VENUSpy: A Chemical 
		Dynamics Simulation Program in the Era of Machine Learning and Exascale Computing}. Journal of 
		Chemical Theory and Computation. 21 (2025) 10679.}
	\item{J.~M.~Waldrop, W.~de~Jong, E.~F.~Valeev, T.~L.~Windus, and \textbf{Ryan~M.~Richard}. 
		\textit{Chemist: A Domain-Specific Language by Chemists for Chemists}. The Journal of Physical Chemistry A. 129 (2025) 7964.}
	\item{C.~Stevens, K.~Kjeer, \textbf{Ryan M. Richard}, E.~Valeev, M.~Cohen. \textit{Model 
		Assisted Refinement of Metamorphic Relations for Scientific Software}. ICSE 2025 New Ideas and Emerging Results (Conference Proceeding). }
	\item{J.~M.~Waldrop, \textbf{Ryan M. Richard}. \textit{Sigma: Uncertainty Propagation for C++}. Journal of Open Source Software. 10 (2025) 7404.}
